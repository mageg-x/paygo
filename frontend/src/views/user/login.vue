  ...
  <div class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input v-model="form.uid" type="number" class="form-input pl-10 pr-3 relative" placeholder="请输入商户ID" required />
          </div>
        </div>
        ...
        <div v-else>
          ...
          <div class="relative">
            ...
            <input v-model="form.key" type="text" class="form-input pl-10 pr-3 relative" placeholder="请输入API密钥" required />
          </div>
        </div>
      ...
      <div class="mt-6 text-center">
        <router-link to="/user/register" class="text-primary-600 hover:text-primary-700 text-sm inline-flex items-center gap-1">
